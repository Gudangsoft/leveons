                    ...
                    <form action="{{ route('admin.consultants.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('consultation_packages') is-invalid @enderror" 
                                              ...
                                              rows="10"
                                              placeholder='[{"name":"Konsultasi 30 Menit","duration":"30 menit","price":1500000,"price_display":"Rp1.500.000","description":"Sesi konsultasi 30 menit","platform":"Google Meet"},{"name":"Konsultasi 60 Menit","duration":"60 menit","price":2500000,"price_display":"Rp2.500.000","description":"Sesi konsultasi 60 menit","platform":"Google Meet"}]'>{{ old('consultation_packages') }}</textarea>
                                    <small class="text-muted">Enter packages in JSON format. Leave empty to add later.</small>
                        ...
                        <div class="border-top pt-3 mt-3">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i>Save Consultant
                            </button>
                            <a href="{{ route('admin.consultants.index') }}" class="btn btn-secondary">
                                Cancel
                            </a>

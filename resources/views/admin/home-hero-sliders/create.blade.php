...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.home-hero-sliders.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Upload gambar untuk background hero. Format: JPEG, PNG, JPG, GIF, WEBP. Max: 2MB. (Opsional - akan menggunakan gambar placeholder jika kosong)</small>

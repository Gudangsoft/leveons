...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>Edit Consultation Package</h2>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('consultant_id') is-invalid @enderror" 
                                ...
                                @foreach($consultants as $consultant)
                                    <option value="{{ $consultant->id }}" {{ old('consultant_id', $package->consultant_id) == $consultant->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="price_display" 
                                   name="price_display" 
                                   value="{{ old('price_display', $package->price_display) }}"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('platform') is-invalid @enderror" 
                                    ...
                                    name="platform" 
                                    required>
                                <option value="Google Meet" {{ old('platform', $package->platform) == 'Google Meet' ? 'selected' : '' }}>Google Meet</option>
                                <option value="Zoom" {{ old('platform', $package->platform) == 'Zoom' ? 'selected' : '' }}>Zoom</option>
                                <option value="Microsoft Teams" {{ old('platform', $package->platform) == 'Microsoft Teams' ? 'selected' : '' }}>Microsoft Teams</option>
                                <option value="WhatsApp Call" {{ old('platform', $package->platform) == 'WhatsApp Call' ? 'selected' : '' }}>WhatsApp Call</option>
                            </select>
                            @error('platform')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror

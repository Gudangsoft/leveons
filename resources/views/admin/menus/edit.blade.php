            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.menus.update', $menu) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                           id="sort_order" name="sort_order" value="{{ old('sort_order', $menu->sort_order) }}" required min="0">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3" id="url-field" style="{{ $menu->type === 'link' ? '' : 'display: none;' }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" 
                                      id="content" name="content" rows="10">{{ old('content', $menu->content) }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @if($menu->hero_background)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/hero_backgrounds/' . $menu->hero_background) }}" 
                            ...
                            <small class="form-text text-muted">Upload gambar untuk background hero section. Format: JPEG, PNG, JPG, GIF, WEBP. Max: 2MB</small>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="is_featured">
                                            ...
                                            <small class="text-muted d-block">Show this menu in homepage featured services section</small>
                                        </label>
                                    </div>
                                    @error('is_featured')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('meta_title') is-invalid @enderror" 
                                           id="meta_title" name="meta_title" value="{{ old('meta_title', $menu->meta_title) }}">
                                    @error('meta_title')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                      id="meta_description" name="meta_description" rows="3">{{ old('meta_description', $menu->meta_description) }}</textarea>
